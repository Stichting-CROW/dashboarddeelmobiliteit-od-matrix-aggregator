...
def prepare_new_calculation_iteration(aggregation_period_id):
    db.new_calculation_iteration_aggregation_period(aggregation_period_id)
    db.delete_od_h3_aggregation_period(aggregation_period_id)
    db.delete_od_geometry_aggregation_period(aggregation_period_id)
...
def get_missing_time_periods():
    start_timestamp = datetime(2021, 12, 25, 0, 0, 0, tzinfo=utc)
